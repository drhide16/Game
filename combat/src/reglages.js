...
const COUPS = {
  poing:    { duree:0.20, debut:0.04, fin:0.12, portee: 26, hauteur:32, dy:-40, degats:1, recul:210, elan: 40, secousse:0.004, son:'poing' },
  ...
  laser:    { duree:0.52, debut:0.18, fin:0.30, portee:520, hauteur:20, dy:-40, degats:2, recul:300, elan:0, secousse:0.011, son:'laser', faisceau:true },
...
const MONSTRES = {
  ...
  gardien: { pv:6,  taille:[28,40], vitesse:120, patrouille:70, degats:1, vol:0,  faible:null,   silhouette:'gardien',
             charge:{ portee:210, preparation:0.4, elan:470, repos:1.4 } },
